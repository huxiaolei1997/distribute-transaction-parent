//package com.xlh.distribute.transaction.seata.account.config;
//
...
// */
//@Configuration
//@MapperScan(value = "com.xlh.distribute.transaction.seata.account.dao", sqlSessionFactoryRef = "sqlSessionFactoryBean1")
...
//        sqlSessionFactoryBean.setMapperLocations(resourcePatternResolver.getResources("mybatis/**/*.xml"));
