 ...
 */
@Configuration
@MapperScan(value = "com.xlh.distribute.transaction.demo.xa.db2.dao", sqlSessionFactoryRef = "sqlSessionFactoryBean2")
public class ConfigDb2 {
    ...
    public DataSource db1() {
        ...
        xaDataSource.setUrl("jdbc:mysql://192.168.3.137:3306/xa_2");
