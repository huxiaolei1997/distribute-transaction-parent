package com.xlh.distribute.transaction.demo.tcc.config;
 ...
 */
@Configuration
@MapperScan(value = "com.xlh.distribute.transaction.demo.tcc.db2.dao", sqlSessionFactoryRef = "sqlSessionFactoryBean2")
